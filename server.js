...
const SERVICES = {
  sub_real:      { price1000: 45,  min: 1, max: 50000 },
  sub_premium:   { price1000: 120, min: 1, max: 20000 },
  views_instant: { price1000: 8,   min: 1, max: 1000000 },
  views_smooth:  { price1000: 6,   min: 1, max: 1000000 },
  react_random:  { price1000: 15,  min: 1, max: 5000 },
  react_premium: { price1000: 25,  min: 1, max: 5000 },
};

/* Соответствие ваших внутренних ID услуг (ключи SERVICES выше) и ID услуг
   в панели twiboost.com. Узнать ID: личный кабинет twiboost → раздел
   Services/Услуги — у каждой позиции указан числовой ID. Впишите сюда
   услуги, которые реально хотите выдавать автоматически; если для какого-то
   ключа мапинга нет, автовыдача для него пропускается и заказ, как раньше,
   уходит вам в чат на ручную обработку. */
